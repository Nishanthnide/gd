...
<div class="d-inline">
<h5>Dashboard</h5>
    <span>You are logged-in to Mechanic control panel.</span>
</div>
</div>
</div>
<div class="col-lg-4">
                        ...
                        <div class="card card-inverse">
							<img id="theImgId" class="card-img" src="../plugins/images/cards/bg5.png" height="120" alt="Card image">
							     <div class="card-img-overlay" style="padding-top: 5px">
								    ...
								    <h4 class="card-title text-uppercase" style="color:white">Hello..! <?php echo $ausername; ?></h4>
								    <p class="card-text" style="color:white">-Gear Doctor</p>
