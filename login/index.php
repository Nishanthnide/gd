...
if (isset($_POST['username']) && isset($_POST['password']))
	{
		...
		if($count==1)
		{
			...
			echo'<script> window.location="../admin1/admin_index.php";</script>';
			//header('Location: index.html');
			
		}
        else
		{
		$queryd="SELECT * FROM `mechanics` WHERE username='$username' AND password='$password'";
		...
		if($countd==1)
		{
			...
			echo'<script> window.location="../mechanic1/mech_index.php";</script>';
			//header('Location: index.html');
			
		}
        else
		{
		$queryd="SELECT * FROM `customer` WHERE username='$username' AND password='$password'";
		$resultd = mysqli_query($connection,$queryd);
		$rowd = mysqli_fetch_assoc($resultd);
		$countd = mysqli_num_rows($resultd);
		if($countd==1)
		{
			$_SESSION['cusername'] = $rowd["username"];
			echo'<script> window.location="../customer1/cust_index.php";</script>';
            ...
            <div class="white-box">
				...
				<?php if(isset($smsg)) { ?> <div class="alert alert-success"> <?php echo $smsg; ?> </div><?php }?>
                    ...
                    <a href="../index.php" class="text-center db"><img src="../plugins/images/GD-logo-dark.png" style="width:80px; height:80px;" alt="Home" />
                        <br/><img src="../plugins/images/GD-Font.png" alt="Home" width="220px" height="55px"/></a>
                    ...
                    <br>
                     <br>
                    <br>
                    <!--<a href="javascript:void(0)" class="text-center db"><img src="../plugins/images/eliteadmin-logo-dark.png" style="width:60px; height:60px;" alt="Home" />
