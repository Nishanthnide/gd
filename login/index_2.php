...
if (isset($_POST['username']) && isset($_POST['password']))
	{
		...
		elseif
		{
		$queryd="SELECT * FROM `mechanics` WHERE (username='$username' OR email='$username') AND password='$password'";
		...
		if($countd==1)
		{
			...
			//define('BASEPATH',TRUE);
			//<script type="text/javascript">location.href = 'newurl';</script>
			echo'<script> window.location="../mechanic/index.php";</script>';
			//header('Location: index.html');
        ...
        <div class="login-box login-sidebar">
            <div class="white-box">
				...
				<?php if(isset($smsg)) { ?> <div class="alert alert-success"> <?php echo $smsg; ?> </div><?php }?>
                    ...
                    <a href="javascript:void(0)" class="text-center db"><img src="../plugins/images/GD-logo-dark.png" style="width:80px; height:80px;" alt="Home" />
                        <br/><img src="../plugins/images/GD-Font.png" alt="Home" /></a>
