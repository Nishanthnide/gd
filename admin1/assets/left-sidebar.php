	...
	<div class="sidebar-nav navbar-collapse slimscrollsidebar">
		<ul class="nav" id="side-menu">
		   ...
		   <li> <a href="javascript:void(0);" class="waves-effect text-white"><i class="fa fa-user p-r-10"></i> <span class="hide-menu"> Admin <span class="fa arrow"></span></span></a>
			...
			<li> <a href="javascript:void(0);" class="waves-effect text-white"><i class="fa fa-user-md p-r-10"></i> <span class="hide-menu"> Mechanics <span class="fa arrow"></span></span></a>
				<ul class="nav nav-second-level">
					<li> <a href="add-mech.php">Add Mechanics</a> </li>
					<li> <a href="view-mech.php">View Mechanics</a> </li>
				</ul>
			</li>
