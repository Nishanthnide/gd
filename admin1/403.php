...
<head>
    ...
    <meta name="description" content="Gear Doctor error page">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="../login/index.php" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Login to get access</a> </div>
