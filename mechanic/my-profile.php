...
$query="SELECT m_id, fname, lname, username, email, gender, address, category, spec, phone, password FROM mechanics WHERE username='$ausername'";
...
if(isset($_POST['updateprofile']))
{
	...
	$uquery="UPDATE mechanics SET fname='$fname', lname='$lname', username='$username', email='$email', gender='$gender', spec='$spec', address='$address', category='$category', phone='$phone' WHERE m_id='$id'";
	$uresult = mysqli_query($connection, $uquery);
	if($uresult)
	{
		$squery="SELECT m_id,fname, lname, username, email, gender, address, category, spec, phone FROM mechanics WHERE username='$ausername'";
...
if(isset($_POST['changepw']))
{
	...
	if($oldpw==$row["password"])
	{
		...
		$pwquery="UPDATE mechanics SET password='$npw' WHERE m_id='$id'";
                            ...
                            <div class="user-bg"> <img width="100%" height="100%" alt="user" src="../plugins/images/profile-menu.png">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><?php if($row["gender"]=='male') { ?> <img src="../plugins/images/users/mech-male.png" class="thumb-lg img-circle" ><?php } else { ?> <img src="../plugins/images/users/mech-fem.png" class="thumb-lg img-circle" > <?php } ?> </a>
                                ...
                                <div class="tab-pane active" id="profile">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Specialist</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row["spec"]; ?></p>
                                        </div>
                             ...
                             <form data-toggle="validator" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-md-12">
										  <div class="form-group">
											   ...
											   <input type="text" name="address" id="address" class="form-control" placeholder="Update your last address" required>
											   <!--<span class="help-block"> This field has error. </span>-->
										   </div>
									 </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label  for="special">Specialization
                                        ...
                                        <input type="text" id="special" name="special" class="form-control" placeholder="e.g. Dentist" value="<?php echo $row["spec"]; ?>" required>
                                </div>
                               <!--<div class="form-group">
