		...
		<ul class="nav" id="side-menu">
			...
			<li class="user-pro">
				<a href="#" class="waves-effect">
					...
					if($rowimg["gender"]=='male'){ ?> <img src="../plugins/images/users/mech-male.png" class="img-circle"><?php } else { ?><img src="../plugins/images/users/mech-fem.png" class="img-circle"> <?php } ?>
			...
			<li> <a href="inbox.php" class="waves-effect text-white"><i class="ti-email"></i> <span class="hide-menu"> Inbox <span class="fa arrow"></span></span></a>
			</li>
			<!---PNB Added Patient menu 
			<li> <a href="javascript:void(0);" class="waves-effect text-white"> <span class="hide-menu"> Inbox <span class="fa arrow"></span></span></a>
				<ul class="nav nav-second-level">
