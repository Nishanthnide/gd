        ...
        <div class="login-box login-sidebar">
            <div class="white-box">
				...
				<?php if(isset($smsg)) { ?> <div class="alert alert-success"> <?php echo $smsg; ?> </div><?php }?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input autofocus tabindex="1" class="form-control" type="text" name="phone" required placeholder="Phone Number" value="<?php if(isset($username) & !empty($username)){ echo $username; }?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input autofocus tabindex="1" class="form-control" type="text" name="otp" required placeholder="Enter the OTP" value="<?php if(isset($username) & !empty($username)){ echo $username; }?>" >
                        </div>
                    </div>
                    <!--<div class="form-group">
                        <div class="col-xs-12">
