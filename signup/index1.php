...
curl_setopt($curl, CURLOPT_POSTFIELDS, "apikey=XBD2FH7TN4F5M6D4O3BOS0DHKAOITIT1&secret=OBK7406PD31CVPQW&usetype=stage&phone=$number&senderid=nishanth2906@gmail.com&message= Hello $username Thank you for choosing Gear Doctor. Your OTP is $message");// post data
...
if(isset($_REQUEST['submit2'])){
    $otpc = $REQUEST['otp'];
    $cquery="select * from ot where otp='$otpc'";
    //$resultch = mysqli_query($connection,$cquery);
    //$row = mysqli_fetch_assoc($resultch);
    //$count = mysqli_num_rows($resultch);
    $rowcount=mysql_num_rows($connection,$cquery);
    if($rowcount==true)
    {
        $_SESSION['otp'] = $otpc;
        ...
        <div class="login-box login-sidebar">
            <div class="white-box">
				...
				<?php if(isset($smsg)) { ?> <div class="alert alert-success"> <?php echo $smsg; ?> </div><?php }?>
                    ...
                    <a href="../index.php" class="text-center db"><img src="../plugins/images/GD-logo-dark.png" style="width:80px; height:80px;" alt="Home" /><br/><img src="../plugins/images/GD-Font.png" alt="Home" style="width:165px; height:55px;" /></a>
                    ...
                    <div class="form-group">
                        <div class="col-xs-8">
                            <input autofocus tabindex="1" class="form-control" type="text" name="email" required placeholder="Email-ID" value="<?php if(isset($mail) & !empty($mail)){ echo $mail; }?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" name="submit1">Get OTP</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input autofocus tabindex="1" class="form-control" type="text" name="otp" required placeholder="Enter the OTP" value="<?php if(isset($otp) & !empty($otp)){ echo $otp; }?>" >
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <a href="../admin/suc.php"><button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" name="submit2">Log In</button></a>
